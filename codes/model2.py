...
class ResNet(nn.Module):
    ...
    def __init__(self, block, blocks_num, include_top=True):
        ...
        if self.include_top:
            ...
            torch.nn.Conv2d(512, 1, kernel_size=(3,1), stride=(1,1), padding=0))
...
def resnet18(include_top=True):
    return ResNet(BasicBlock, [2, 2, 2, 2], include_top=include_top)
